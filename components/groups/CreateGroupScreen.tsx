  ...
  return (
    <main className="mx-auto min-h-dvh w-full max-w-[440px] bg-[#FBFFFF] px-4 pb-8 pt-5 font-sans">
      <div className="flex items-center gap-2">
        <Link href="/home" aria-label="ย้อนกลับ" className="grid size-8 place-items-center">
      ...
      >
        <div className="mb-4 flex items-center gap-2">
          ...
          <h2 className="text-[16px] font-bold text-[var(--color-text)]">รายละเอียด</h2>
        </div>
        ...
        <div className="space-y-4">
          ...
          <label className="block">
            ...
            <textarea
              ...
              className="mt-2 h-[104px] w-full resize-none rounded-[9px] border border-[#E6E6E6] px-3 py-3 text-[15px] outline-none placeholder:text-[#C4C4C4] focus:border-[var(--color-primary)]"
            />
          </label>
          ...
          <label className="block">
            ...
            <input
              ...
              inputMode="numeric"
              min={1}
              placeholder="ระบุหมายเลขคอร์ท เช่น 1, C1, C2-C5"
              className="mt-2 h-[43px] w-full rounded-[9px] border border-[#E6E6E6] px-3 text-[15px] outline-none placeholder:text-[#C4C4C4] focus:border-[var(--color-primary)]"
            />
          </label>
          ...
          <label className="flex items-start justify-between gap-4">
            ...
            <input
              name="highScoreMode"
              type="checkbox"
              className="mt-1 h-6 w-11 rounded-full accent-[var(--color-primary)]"
            />
          </label>
        </div>
